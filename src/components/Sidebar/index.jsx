...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
    ...
    return (
        <aside className={`absolute left-0 top-0 z-9999 flex flex-col h-screen w-72 overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0
